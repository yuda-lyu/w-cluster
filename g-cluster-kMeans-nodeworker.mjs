...
//注意: 本檔走 dist 建置版(WebWorker bundle)。seed/usePCA/funDist 為近期 src 新增,
//      須先重新 build dist 後, 此處 seed 才會生效; 否則 dist 舊版 k-means 仍為隨機, 下列輸出僅供參考
...
//node g-cluster-kMeans-nodeworker.mjs
